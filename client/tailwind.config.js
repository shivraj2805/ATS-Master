  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-mesh': 'linear-gradient(135deg, #06b6d4 0%, #2563eb 100%)',
        'gradient-premium': 'linear-gradient(135deg, #06b6d4 0%, #3b82f6 50%, #60a5fa 100%)',
        'gradient-sunset': 'linear-gradient(135deg, #fa709a 0%, #fee140 100%)',
        'gradient-ocean': 'linear-gradient(135deg, #06b6d4 0%, #1bffff 100%)',
